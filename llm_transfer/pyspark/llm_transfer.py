...
def main(db, sql, con, spark, output_path, prompt_path, source_data_path, iteration_num, model, reasoning, method, base_url, csv_dir, api_key, tables, csv_context, dfg_host_port, feature=False, DFG=False, Explanation=True):
    chat_kwargs = dict(
        model=model,
        base_url=base_url,
        api_key=api_key,
...
if __name__ == "__main__":
    ...
    for i, sql in enumerate(sql_statements):
        ...
        try:
            main(args.db, sql, con, spark, result_path, prompt_path, source_data_path, args.iteration_num, model, args.reasoning, args.method, base_url, args.csv_dir, args.api_key, tables, csv_context, args.dfg_host_port, feature=args.feature, DFG=args.DFG, Explanation=args.Explanation)
        except Exception as e:
            print(e)
            continue
