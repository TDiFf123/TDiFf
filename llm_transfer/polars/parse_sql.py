...
def process_sql_features(sql: str, db: str):
    ...
    clause_map = load_function_map("./feature_mapping/duckdb_polars_clause_map.jsonl")
    func_map = load_function_map("./feature_mapping/duckdb_polars_function_map.jsonl")
