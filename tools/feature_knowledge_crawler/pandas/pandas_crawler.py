import os
import json
from dev1.sql2py.tools.feature_knowledge_crawler.pandas.htmls_crawler import htmls_crawler
from dev1.sql2py.tools.feature_knowledge_crawler.pandas.info_crawler import crawler_results
...
def pandas_crawler():
    dic_path = os.path.join(current_dir, "..", "..", "FeatureKnowledgeBase", "pandas")
